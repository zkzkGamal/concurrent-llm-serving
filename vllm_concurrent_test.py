...
"""
see ./setup_vllm.txt
to install and run vllm
i run command vllm to start server at 
(APIServer pid=254791) INFO 03-15 15:21:21 [utils.py:297] 
and server up at 
(APIServer pid=254791) INFO 03-15 15:24:42 [launcher.py:46] Route: /v1/completions/render, Methods: POST
also notic i need to send warm up message to start serving 
"""
# ---------------------------
# 1️⃣ Setup logging (console + file)
# ---------------------------
log_file = "vllm_concurrent_test.log"
logging.basicConfig(
    level=logging.INFO,
...
async def main():
    ...
    report_file = "vllm_results.md"
    with open(report_file, "w", encoding="utf-8") as f:
        f.write("# 🟢 vLLM Concurrent Test Results\n\n")
        f.write("**Model:** `Qwen/Qwen3.5-0.8B` via vLLM (OpenAI compatible)\n")
